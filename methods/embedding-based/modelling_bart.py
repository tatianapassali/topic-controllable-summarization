    ...
    def forward(
        ...
        Args:
            ...
            head_mask (:obj:`torch.Tensor` of shape :obj:`(encoder_layers, encoder_attention_heads)`, `optional`):
             ...
             topic_ids(:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`:
                Indices of topic in the dataset.)
        ...
        if topic_ids is None:
            raise ValueError("You have to specify topics ids")


        embed_pos = self.embed_positions(input_shape)

        # Define topic embeddings
        embed_topic = self.topic_embeddings(topic_ids)

        # Add topic embeddings along with positional encoding
        hidden_states = inputs_embeds + embed_pos + embed_topic
...
class BartModel(BartPretrainedModel):
    ...
    def forward(
        ...
        return Seq2SeqModelOutput(
            ...
            past_key_values=decoder_outputs.cross_attentions,
